  ...
  return (
    <div className="w-64 bg-primary-800 text-primary-100 flex flex-col">
      <div className="h-16 flex items-center justify-center border-b border-primary-700">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-primary-300 mr-2">
      ...
      <nav className="flex-1 p-4 space-y-2">
        {links.map((link) => (
          <NavLink
            ...
            to={link.path}
            className={({ isActive }) =>
              `flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-colors duration-150 ease-in-out hover:bg-primary-700 hover:text-white ${
                isActive ? 'bg-primary-700 text-white font-medium shadow-md' : 'text-primary-200'
              }`
            }
          >
      ...
      <div className="p-4 border-t border-primary-700">
        <p className="text-xs text-primary-400 text-center">&copy; {new Date().getFullYear()} EduTrack</p>
      </div>
    </div>
  );
};
